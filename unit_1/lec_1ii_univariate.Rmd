...
* There is a fixed probability $\alpha$ of finding the *sample mean*
...
text(-3.4, 1, expression(symbol(alpha)==0.95), cex=1.3)
```
...
* Cool! **One sample** is enough for a good **interval estimate** of $\mu$. But wait - how do I know $\sigma$?? 
