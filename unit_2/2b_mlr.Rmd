...
We usually do not measure it, rather we apprimate it with Akaike's Information Criterion (AIC)
...
Such models are prone to **Overfitting**:" irrelevant predictors that correlate with the outcomes by chance result in a model that its the dataset well, but performs poorly when challenged with new data (low **transferability**)
