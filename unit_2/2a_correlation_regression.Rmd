...
* **data**: A data frame containing all the variables you want to work with
...
* **data**: A data frame containing all the variables you want to work with
* One or more **aesthetic mappings**
	- defined using `aes` function
	- How to *map* data to visual information
	- what is x, what is y
	- how to use colour, size or shape of symbols, etc
...
* One or more **aesthetic mappings**
	...
	- what is x, what is y
	- how to use colour, size or shape of symbols, etc
* A **geometry** describing what geometric objects to use in the plot
	- points, lines, histograms, bars, boxplots, etc.
